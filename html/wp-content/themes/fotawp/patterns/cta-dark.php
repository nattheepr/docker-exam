...
<div class="wp-block-group has-background" style="background-color:#141313;padding-top:8rem;padding-right:var(--wp--preset--spacing--50);padding-bottom:8rem;padding-left:var(--wp--preset--spacing--50)"><!-- wp:heading {"textAlign":"center","level":5,"textColor":"background-alt"} -->
    <h5 class="wp-block-heading has-text-align-center has-background-alt-color has-text-color">Call to Action</h5>
    <!-- /wp:heading -->
    ...
    <h1 class="wp-block-heading has-text-align-center has-foregound-alt-color has-text-color" style="font-size:64px;font-style:normal;font-weight:500;line-height:1.4">Need help to setup and plan business?</h1>
    <!-- /wp:heading -->

    <!-- wp:paragraph {"align":"center","style":{"color":{"text":"#d6d6d6"},"typography":{"fontSize":"18px","lineHeight":2}}} -->
    <p class="has-text-align-center has-text-color" style="color:#d6d6d6;font-size:18px;line-height:2">The placeholder text, beginning with the line&nbsp;“Lorem ipsum dolor sit amet, consectetur adipiscing elit”, looks like Latin because in its youth, centuries ago, it was Latin.</p>
    <!-- /wp:paragraph -->
